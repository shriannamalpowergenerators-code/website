                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10 text-center md:text-left">
                    <div className="max-w-3xl">
                        <motion.span
                            ...
                            className="text-[10px] md:text-[11px] font-bold tracking-[0.4em] uppercase mb-4 block text-gray-300"
                        >
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="text-center mb-14">
                            ...
                            <p className="max-w-4xl mx-auto text-gray-500 text-sm md:text-lg leading-relaxed font-sans">
                                ...
                                support systems, and mission-critical infrastructure across India. We offer the best generators in India.
                            </p>
                        </div>
