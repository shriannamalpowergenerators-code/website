...
export const metadata: Metadata = {
  ...
  description: "SAPGENE – India's authorized Cummins Powerica dealer. Buy or rent diesel generators & DG sets in Chennai, Pondicherry & Tamil Nadu. Call +91-9442946598.",
